...
$(document).ready(function () {
      ...
      success: function (result, state, xhr) {
         $.each(result, function (index, jsonObject) {
            $.each(jsonObject, function (key, val) {
               $('.select-table-filter').append('<option value="' + val + '">' + val + '</option>');
            });
         });
      },
   ...
   $('.menu_table_body').on('change', '.food_Quantity_InCart', function () {
      if ($(this).val() != '') {
         ...
         $('#custom_food_price-' + $(this).data('value')).text($('#food_price-' + $(this).data('value')).text().trim() * $(this).val());
         $('#cart_food_price-' + $(this).data('value')).text($('#custom_food_price-' + $(this).data('value')).text());
...
function cloneRow(food_id, food_name, food_quantity_InCart, food_Price) {
   ...
   clonedRow.find('.food_quantity_InCart').attr('id', 'cart_food_quantity-' + food_id);
