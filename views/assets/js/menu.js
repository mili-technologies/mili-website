...
$(document).ready(function () {
   ...
   $('.menu_table_body').on("click", '.food_resturant_add', function () {
      ...
      var jsonData = { food_id: food_Id, food_name: food_Name, food_category: food_Category, food_ingredents: food_Ingredents, food_price: food_Price };
   ...
   $('.confirm-modal').on("click", '#confirm_remove', function () {
      ...
      var food_Ingredents;
      var food_Price;
      var jsonData = { food_resturant_id: food_Resturant_Id, food_name: food_Name, food_category: food_Category, food_ingredents: food_Ingredents, food_price: food_Price };
   ...
   $('.menu_table_body').on('change', '.food_status', function () {
      ...
      var jsonData = { restaurant_food_Id: food_Resturant_Id, food_status: food_Status };
   ...
   $('.menu_table_body').on('change', '.food_recommended', function () {
      ...
      var jsonData = { restaurant_food_Id: food_Resturant_Id, food_recommended: food_recommended };
   ...
   $.ajax({
      ...
      success: function (result, state, xhr) {
         $.each(result, function (i, obj) {
            if (!findElement(obj)) {
               addRow(obj.restaurant_food_menu_id, obj.restaurant_food_img_url, obj.food_name, obj.menu_category, obj.food_quantity, obj.food_price, obj.is_available, obj.is_recommended, 'menu_table_body');
            } else {
               updateRow(obj.restaurant_food_menu_id, obj.restaurant_food_img_url, obj.food_name, obj.menu_category, obj.food_quantity, obj.food_price, obj.is_available, obj.is_recommended);
            }
         });
      }
   });
...
function addRow(food_resturant_id, restaurant_food_img_url, food_name, food_category, food_ingredents, food_price, is_available, is_recommended, table_name) {
   ...
   cloneRow(food_Resturant_Id, restaurant_food_img_url, food_Name, food_Category, food_Ingredents, food_Price, food_availability, food_recommended, table_name);
}

function cloneRow(food_Resturant_Id, restaurant_food_img_url, food_Name, food_Category, food_Ingredents, food_Price, food_availability, food_recommended, table_name) {
   ...
   clonedRow.find('.food_recommended').attr('id', 'food_recommended-' + food_Resturant_Id);
...
function updateRow(food_resturant_id, food_name, food_category, food_ingredents, food_price) {
